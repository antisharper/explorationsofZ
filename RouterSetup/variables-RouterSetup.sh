...
if [ ! -x ~/.LOCALROUTEROCTET ]; then echo LOCALROUTEROCTET=$[$RANDOM/256] > ~/.LOCALROUTEROCTET; fi
...
export ADDPACKAGELIST=(openvpn hostapd dnsmasq curl wget netstat-nat tcpdump nmap python-gpiozero nethogs git dkms bc)
